...
public interface RepositorioServicio {
    ...
    PaginaDto<ServicioDto> consultarInformacionServicios(
            Double latitud, Double longitud, int pagina, int cantidad);
    PaginaDto<ServicioDto> consultarInformacionServiciosPorSolicitante
            (String identificadroSolicitante, int pagina, int cantidad);
